...
var gbHideBottom=false;	// true: hide the bottom section; false: show it with gsBottom.
                        // true: bottom section을 숨긴다.
var gsBottom=(NN4?"":"<DIV class='BottomDiv'>")+"<A class='BottomAnchor' href='javascript:void(0)' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"You cannot select today!\");return false;' onmouseover='return true;' >오늘</A>"+(NN4?"":"</DIV>");	// the content of the bottom section.
gsBottom += (NN4?"":"<DIV class='BottomDiv'>")+"<A class='BottomAnchor' href='javascript:void(0)' onclick='if(this.blur)this.blur();fClearSelected();return false;' onmouseover='return true;'>초기화</A>"+(NN4?"":"</DIV>");

...
#  cmd=$cmd":lib/shared/activemq-all-5.6.0.jar"
#  cmd=$cmd":lib/Application/jsdldoc.jar"
  cmd=$cmd":lib/shared/mail-1.4.3.jar"    
#  cmd=$cmd":dist/htcaas_web.jar"   
...
#  cmd=$cmd":lib/cli/neethi-2.0.4.jar"       
  ...
  cmd=$cmd" org.kisti.htc.cli.client.GetJobResultAutodock -w $wd $1 $2 $3 $4 $5 $6 $7 $8"
